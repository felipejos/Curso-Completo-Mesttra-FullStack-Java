...
<!-- nav_start -->
---
Anterior: [ExercÃ­cio Salvando dados em txt](../docs/137_Salvando_TXT.md) | Próximo: [IntroduÃ§Ã£o ao Banco de Dados](../docs/139_Introducao_Banco_de_Dados.md) | [Voltar ao Índice](../README.md)
<!-- nav_end -->
