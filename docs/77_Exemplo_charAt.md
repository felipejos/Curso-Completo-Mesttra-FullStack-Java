...
<!-- nav_start -->
---
Anterior: [charAt() - Obtendo uma posiÃ§Ã£o de uma String](../docs/76_charAt.md) | Próximo: [Calculadora de Ã¡rea de Figuras GeomÃ©tricas](../docs/78_Calculadora_Area.md) | [Voltar ao Índice](../README.md)
<!-- nav_end -->
