...
<!-- nav_start -->
---
Anterior: [Esqueleto bÃ¡sico das 4 OperaÃ§Ãµes](../docs/152_Esqueleto_4_Operacoes.md) | Próximo: [Reescrevendo uma aplicaÃ§Ã£o para banco de dados](../docs/154_Reescrevendo_App_BD.md) | [Voltar ao Índice](../README.md)
<!-- nav_end -->
