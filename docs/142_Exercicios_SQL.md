...
<!-- nav_start -->
---
Anterior: [Resumo comando SELECT Banco de Dados](../docs/141_Resumo_SELECT.md) | Próximo: [Banco de Dados Agenda TelefÃ´nica](../docs/143_Agenda_Telefonica.md) | [Voltar ao Índice](../README.md)
<!-- nav_end -->
